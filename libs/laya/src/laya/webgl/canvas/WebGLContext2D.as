package laya.webgl.canvas {
	...
	public class WebGLContext2D extends Context {
		...
		override public function arcTo(x1:Number, y1:Number, x2:Number, y2:Number, r:Number):void {
			...
			x1 = _curMat.a * _x1 + _curMat.c * _y1 + _curMat.tx;
			y1 = _curMat.b * _x1 + _curMat.d * _y1 + _curMat.ty;
			_x1 = x2, _y1 = y2;
			x2 = _curMat.a * _x1 + _curMat.c * _y1 + _curMat.tx;
			y2 = _curMat.b * _x1 + _curMat.d * _y1 + _curMat.ty;
